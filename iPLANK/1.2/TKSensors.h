...
#define MAX_TOUCHES 4 // Maximum number of touches on each sensor. Depends on sensor type (black TouchKey = 3, DBox TouchKey = 5)
int sensorType = 2; // Type of sensors used (black TouchKey = 0, DBox TouchKey = 2)
int sensorAddress[NUM_SENSORS] = {0x18}; // I2c address for each sensor (default = 0x18, 0x19)
// ------------------------------------------------------------------------------------------------------------------------------
