...
#define MAX_TOUCHES 5 // Maximum number of touches on each sensor. Depends on sensor type (black TouchKey = 3, DBox TouchKey = 5)
int sensorType = 0; // Type of sensors used (black TouchKey = 0, DBox TouchKey = 2)
int sensorAddress[NUM_SENSORS] = {0x06, 0x0a}; // I2c address for each sensor (default = 0x18, 0x19)
// ------------------------------------------------------------------------------------------------------------------------------
