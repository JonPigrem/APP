...
#define CAPSLIDER_MODE_NORMAL	0
#define CAPSLIDER_MODE_RAW		1
#define CAPSLIDER_MODE_BASELINE	2
#define CAPSLIDER_MODE_DIFF		3

#define CAPSLIDER_DEVICE_NONE	0
#define CAPSLIDER_DEVICE_1D		1
#define CAPSLIDER_DEVICE_2D		2

#define CAPSLIDER_SPEED_ULTRA_FAST 0
#define CAPSLIDER_SPEED_FAST	   1
#define CAPSLIDER_SPEED_NORMAL     2
#define CAPSLIDER_SPEED_SLOW	   3
 

class CapSlider {
public:
	CapSlider(uint8_t i2c_address, uint8_t reset_pin = 0);
